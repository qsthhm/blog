              ...
              const ProjectWrapper = project.link ?
                ({ children }) => (
                  <a
                    ...
                    className="group block relative hover:bg-neutral-50 dark:hover:bg-neutral-800/50 hover:shadow-[0_0_0_10px_rgb(250,250,250)] dark:hover:shadow-[0_0_0_10px_rgb(38,38,38,0.5)] transition-all rounded-lg"
                  >
                    {children}
